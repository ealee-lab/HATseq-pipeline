...
## Reference Folder ##
This folder should contain the FASTA file of the reference genome along with the BWA index.
```
...
```
cd workflow
vim run_HATseq-pipeline.sh # Edit: your.email@you.com, your_partition, your_account, /path/to/HATseq-pipeline, /path/to/output/
cd slurm
